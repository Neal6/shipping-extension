...
(function () {
  ...
  Range.prototype = {
    ...
    sendkeys: function (text) {
      ...
      text.replace(/{[^}]*}|[^{]+|{/g, (part) =>
        (bililiteRange.sendkeys[part] || simplechar)(this, part, simplechar)
      );
  ...
  W3CRange.prototype._nativeSelection = function () {
    ...
    if (this._win.getSelection().rangeCount == 0)
      return [this.length, this.length]; // append to the end
